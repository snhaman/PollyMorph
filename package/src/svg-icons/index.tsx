// Auto-generated React SVG icon components — do not edit manually
// 185 icons from PDS-Icon-Font-20 / Figma Export V2.0
// Usage: import { IconEdit, IconSettings } from '@snhaman/pollymorph/react-icons'
...
export const IconMeatballsSettings = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
...
export const IconShortlist = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M6.99981 8H16.9998V9.5H6.99981V8Z" fill="currentColor"/>
<path d="M6.99981 11.5H16.9998V13H6.99981V11.5Z" fill="currentColor"/>
<path d="M6.99981 15H11.9998V16.5H6.99981V15Z" fill="currentColor"/>
<path d="M3.49942 20H20.4994C20.4994 20.8284 19.8278 21.5 18.9994 21.5H4.99942C4.17099 21.5 3.49942 20.8284 3.49942 20Z" fill="currentColor"/>
<path d="M14.4994 3C14.4994 4.38071 13.3801 5.5 11.9994 5.5C10.6187 5.5 9.49942 4.38071 9.49942 3C9.49942 1.61929 10.6187 0.5 11.9994 0.5C13.3801 0.5 14.4994 1.61929 14.4994 3ZM10.9994 3C10.9994 3.55228 11.4471 4 11.9994 4C12.5517 4 12.9994 3.55228 12.9994 3C12.9994 2.44772 12.5517 2 11.9994 2C11.4471 2 10.9994 2.44772 10.9994 3Z" fill="currentColor"/>
<path d="M7.99942 4H15.9994V4.3C15.9994 4.96274 15.4622 5.5 14.7994 5.5H9.19942C8.53668 5.5 7.99942 4.96274 7.99942 4.3V4Z" fill="currentColor"/>
<path d="M7.99942 3.2C7.99942 2.53726 8.53668 2 9.19942 2H9.99942V4L7.99942 4V3.2Z" fill="currentColor"/>
<path d="M13.9994 2H14.7994C15.4622 2 15.9994 2.53726 15.9994 3.2V4L13.9994 4V2Z" fill="currentColor"/>
<path d="M3.49942 4.5C3.49942 3.67157 4.17099 3 4.99942 3L4.99942 21.5C4.17099 21.5 3.49942 20.8284 3.49942 20V4.5Z" fill="currentColor"/>
<path d="M18.9998 2.99998C19.8282 2.99998 20.4998 3.67155 20.4998 4.49998L20.4994 20C20.4994 20.8284 19.8278 21.5 18.9994 21.5L18.9998 2.99998Z" fill="currentColor"/>
<path d="M3.49942 4.5C3.49942 3.67157 4.17099 3 4.99942 3H9.49942V4.5L3.49942 4.5Z" fill="currentColor"/>
<path d="M14.4994 3L18.9998 2.99998C19.8282 2.99998 20.4998 3.67155 20.4998 4.49998H14.4998L14.4994 3Z" fill="currentColor"/>
  </svg>
);
IconShortlist.displayName = 'IconShortlist';

export const IconUploadFile = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M17.9996 14V17H5.9996V14H3.9996V17C3.9996 18.1 4.8996 19 5.9996 19H17.9996C19.0996 19 19.9996 18.1 19.9996 17V14H17.9996ZM6.9996 7.99997L8.4096 9.40997L10.9996 6.82997V15H12.9996V6.82997L15.5896 9.40997L16.9996 7.99997L11.9996 2.99997L6.9996 7.99997Z" fill="currentColor"/>
  </svg>
);
IconUploadFile.displayName = 'IconUploadFile';

export const IconDownloadFile = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M17.9996 14V17H5.9996V14H3.9996V17C3.9996 18.1 4.8996 19 5.9996 19H17.9996C19.0996 19 19.9996 18.1 19.9996 17V14H17.9996ZM16.9996 9.99997L15.5896 8.58997L12.9996 11.17V2.99997H10.9996V11.17L8.4096 8.58997L6.9996 9.99997L11.9996 15L16.9996 9.99997Z" fill="currentColor"/>
  </svg>
);
IconDownloadFile.displayName = 'IconDownloadFile';

export const IconEdit = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
<path d="M16.4996 -3.05176e-05H4.4996C3.3996 -3.05176e-05 2.4996 0.899969 2.4996 1.99997V16H4.4996V1.99997H16.4996V-3.05176e-05ZM19.4996 3.99997H8.4996C7.3996 3.99997 6.4996 4.89997 6.4996 5.99997V20C6.4996 21.1 7.3996 22 8.4996 22H19.4996C20.5996 22 21.4996 21.1 21.4996 20V5.99997C21.4996 4.89997 20.5996 3.99997 19.4996 3.99997ZM19.4996 20H8.4996V5.99997H19.4996V20Z" fill="currentColor"/>
</g>
<defs>
...
export const IconPrint = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M19.0004 7H18.0004V2H6.00037V7H5.00037C3.34037 7 2.00037 8.34 2.00037 10V16H6.00037V20H18.0004V16H22.0004V10C22.0004 8.34 20.6604 7 19.0004 7ZM8.00037 4H16.0004V7H8.00037V4ZM16.0004 18H8.00037V14H16.0004V18ZM18.0004 14V12H6.00037V14H4.00037V10C4.00037 9.45 4.45037 9 5.00037 9H19.0004C19.5504 9 20.0004 9.45 20.0004 10V14H18.0004Z" fill="currentColor"/>
<path d="M18.0004 11.5C18.5527 11.5 19.0004 11.0523 19.0004 10.5C19.0004 9.94772 18.5527 9.5 18.0004 9.5C17.4481 9.5 17.0004 9.94772 17.0004 10.5C17.0004 11.0523 17.4481 11.5 18.0004 11.5Z" fill="currentColor"/>
  </svg>
);
IconPrint.displayName = 'IconPrint';

export const IconOpenInNewWindow = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M19 18H5V4H12V2H5C3.89 2 3 2.9 3 4V18C3 19.1 3.89 20 5 20H19C20.1 20 21 19.1 21 18V11H19V18ZM14 2V4H17.59L7.76 13.83L9.17 15.24L19 5.41V9H21V2H14Z" fill="currentColor"/>
  </svg>
);
IconOpenInNewWindow.displayName = 'IconOpenInNewWindow';

export const IconTableEditor = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M14.5 1.5H4.5C3.4 1.5 2.5 2.4 2.5 3.5V13.5C2.5 14.6 3.4 15.5 4.5 15.5C4.5 15.5 11.4 15.5 12.5 15.5L16.5 11.5V3.5C16.5 2.4 15.6 1.5 14.5 1.5ZM14.5 3.5V5.5H4.5V3.5H14.5ZM8.5 9.5V7.5H10.5V9.5H8.5ZM10.5 11.5V13.5H8.5V11.5H10.5ZM6.5 9.5H4.5V7.5H6.5V9.5ZM12.5 7.5H14.5V9.5H12.5V7.5ZM4.5 11.5H6.5V13.5H4.5V11.5ZM12.5 13.5V11.5H14.5V13.5H12.5Z" fill="currentColor"/>
<path d="M20.512 14.5772L21.2117 13.8775C21.5961 13.4932 21.5961 12.8723 21.2117 12.488L20.512 11.7883C20.1277 11.4039 19.5068 11.4039 19.1225 11.7883L18.4228 12.488L20.512 14.5772Z" fill="currentColor"/>
<path d="M19.8123 15.2769L17.7231 13.1877L12.5 18.4108V20.5H14.5892L19.8123 15.2769Z" fill="currentColor"/>
  </svg>
);
IconTableEditor.displayName = 'IconTableEditor';

export const IconPollyFlow = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconPollyPipelines = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M17.4545 17.3636H13.8182V19.1818C13.3161 19.1818 12.9091 19.5888 12.9091 20.0909C12.9091 20.593 13.3161 21 13.8182 21H17.4545C17.9566 21 18.3636 20.593 18.3636 20.0909C18.3636 19.5888 17.9566 19.1818 17.4545 19.1818V17.3636Z" fill="currentColor"/>
<path d="M10.1818 1H6.54545C6.04338 1 5.63636 1.40701 5.63636 1.90909C5.63636 2.41117 6.04338 2.81818 6.54545 2.81818L6.54545 4.63636H10.1818V2.81818C10.6839 2.81818 11.0909 2.41117 11.0909 1.90909C11.0909 1.40701 10.6839 1 10.1818 1Z" fill="currentColor"/>
<path d="M10.1818 10.0909H6.54545V11C6.54545 14.0125 8.98754 16.4545 12 16.4545H20.1818C20.1818 16.9566 20.5888 17.3636 21.0909 17.3636C21.593 17.3636 22 16.9566 22 16.4545V12.8182C22 12.3161 21.593 11.9091 21.0909 11.9091C20.5888 11.9091 20.1818 12.3161 20.1818 12.8182H12C10.9958 12.8182 10.1818 12.0042 10.1818 11V10.0909Z" fill="currentColor"/>
<path d="M13.8182 11.9091H17.4545V11C17.4545 7.98754 15.0125 5.54546 12 5.54546L3.81818 5.54545C3.81818 5.04338 3.41117 4.63636 2.90909 4.63636C2.40701 4.63636 2 5.04338 2 5.54545V9.18182C2 9.6839 2.40701 10.0909 2.90909 10.0909C3.41117 10.0909 3.81818 9.6839 3.81818 9.18182L12 9.18182C13.0042 9.18182 13.8182 9.99585 13.8182 11V11.9091Z" fill="currentColor"/>
  </svg>
);
IconPollyPipelines.displayName = 'IconPollyPipelines';

export const IconHamburgerMenuToggle = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M3 17H16V15H3V17ZM3 12H13V10H3V12ZM3 5V7H16V5H3Z" fill="currentColor"/>
<path d="M21 14.59L17.42 11L21 7.41L19.59 6L14.59 11L19.59 16L21 14.59Z" fill="currentColor"/>
  </svg>
);
IconHamburgerMenuToggle.displayName = 'IconHamburgerMenuToggle';

export const IconHamburgerMenu = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M3 17H21V15H3V17ZM3 12H21V10H3V12ZM3 5V7H21V5H3Z" fill="currentColor"/>
  </svg>
);
IconHamburgerMenu.displayName = 'IconHamburgerMenu';

export const IconCheckBoxSelected = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M9.42 17.0368L4 11.6168L5.897 9.71981L9.42 13.2428L18.363 4.2998L20.26 6.19681L9.42 17.0368Z" fill="currentColor"/>
  </svg>
);
IconCheckBoxSelected.displayName = 'IconCheckBoxSelected';

export const IconCheckBoxIndeterminate = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M5.22498 13V10.29H18.775V13H5.22498Z" fill="currentColor"/>
  </svg>
);
IconCheckBoxIndeterminate.displayName = 'IconCheckBoxIndeterminate';

export const IconAddReport = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconViewReport = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M12.975 4.33317L17 8.35817V17.6665H7.00004V4.33317H12.975ZM13.6667 2.6665H7.00004C6.08337 2.6665 5.33337 3.4165 5.33337 4.33317V17.6665C5.33337 18.5832 6.08337 19.3332 7.00004 19.3332H17C17.9167 19.3332 18.6667 18.5832 18.6667 17.6665V7.6665L13.6667 2.6665Z" fill="currentColor"/>
  </svg>
);
IconViewReport.displayName = 'IconViewReport';

export const IconKey = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M21 9.5H12.65C11.83 7.17 9.61 5.5 7 5.5C3.69 5.5 1 8.19 1 11.5C1 14.81 3.69 17.5 7 17.5C9.61 17.5 11.83 15.83 12.65 13.5H13L15 15.5L17 13.5L19 15.5L23 11.46L21 9.5ZM7 14.5C5.35 14.5 4 13.15 4 11.5C4 9.85 5.35 8.5 7 8.5C8.65 8.5 10 9.85 10 11.5C10 13.15 8.65 14.5 7 14.5Z" fill="currentColor"/>
  </svg>
);
IconKey.displayName = 'IconKey';

export const IconDatabaseIcon = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M12 6.5C16.4183 6.5 20 5.38071 20 4C20 2.61929 16.4183 1.5 12 1.5C7.58172 1.5 4 2.61929 4 4C4 5.38071 7.58172 6.5 12 6.5ZM20 5C20 6.38071 16.4183 7.5 12 7.5C7.58172 7.5 4 6.38071 4 5V9C4 10.3807 7.58172 11.5 12 11.5C16.4183 11.5 20 10.3807 20 9V5ZM12 12.5C16.4183 12.5 20 11.3807 20 10V14C20 15.3807 16.4183 16.5 12 16.5C7.58172 16.5 4 15.3807 4 14V10C4 11.3807 7.58172 12.5 12 12.5ZM20 15C20 16.3807 16.4183 17.5 12 17.5C7.58172 17.5 4 16.3807 4 15V19C4 20.3807 7.58172 21.5 12 21.5C16.4183 21.5 20 20.3807 20 19V15Z" fill="currentColor"/>
  </svg>
);
IconDatabaseIcon.displayName = 'IconDatabaseIcon';

export const IconTableSort = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M16.0004 16.01V9H14.0004V16.01H11.0004L15.0004 20L19.0004 16.01H16.0004ZM9.00039 2L5.00039 5.99H8.00039V13H10.0004V5.99H13.0004L9.00039 2ZM16.0004 16.01V9H14.0004V16.01H11.0004L15.0004 20L19.0004 16.01H16.0004ZM9.00039 2L5.00039 5.99H8.00039V13H10.0004V5.99H13.0004L9.00039 2Z" fill="currentColor"/>
  </svg>
);
IconTableSort.displayName = 'IconTableSort';

export const IconDatabaseSettings = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconDatabaseAddIcon = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconFrameworkOntologyFlowchart = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconThumbUpFilled = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M1 21.5H5V9.5H1V21.5ZM23 10.5C23 9.4 22.1 8.5 21 8.5H14.69L15.64 3.93L15.67 3.61C15.67 3.2 15.5 2.82 15.23 2.55L14.17 1.5L7.59 8.09C7.22 8.45 7 8.95 7 9.5V19.5C7 20.6 7.9 21.5 9 21.5H18C18.83 21.5 19.54 21 19.84 20.28L22.86 13.23C22.95 13 23 12.76 23 12.5V10.5Z" fill="currentColor"/>
  </svg>
);
IconThumbUpFilled.displayName = 'IconThumbUpFilled';

export const IconThumbUp = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M9 21.5H18C18.83 21.5 19.54 21 19.84 20.28L22.86 13.23C22.95 13 23 12.76 23 12.5V10.5C23 9.4 22.1 8.5 21 8.5H14.69L15.64 3.93L15.67 3.61C15.67 3.2 15.5 2.82 15.23 2.55L14.17 1.5L7.58 8.09C7.22 8.45 7 8.95 7 9.5V19.5C7 20.6 7.9 21.5 9 21.5ZM9 9.5L13.34 5.16L12 10.5H21V12.5L18 19.5H9V9.5ZM1 9.5H5V21.5H1V9.5Z" fill="currentColor"/>
  </svg>
);
IconThumbUp.displayName = 'IconThumbUp';

export const IconThumbDownFilled = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M15 1.5H6C5.17 1.5 4.46 2 4.16 2.72L1.14 9.77C1.05 10 1 10.24 1 10.5V12.5C1 13.6 1.9 14.5 3 14.5H9.31L8.36 19.07L8.33 19.39C8.33 19.8 8.5 20.18 8.77 20.45L9.83 21.5L16.42 14.91C16.78 14.55 17 14.05 17 13.5V3.5C17 2.4 16.1 1.5 15 1.5ZM19 1.5V13.5H23V1.5H19Z" fill="currentColor"/>
  </svg>
);
IconThumbDownFilled.displayName = 'IconThumbDownFilled';

export const IconThumbDown = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconMailIcon = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M20 3.5H4C2.9 3.5 2.01 4.4 2.01 5.5L2 17.5C2 18.6 2.9 19.5 4 19.5H20C21.1 19.5 22 18.6 22 17.5V5.5C22 4.4 21.1 3.5 20 3.5ZM20 17.5H4V7.5L12 12.5L20 7.5V17.5ZM12 10.5L4 5.5H20L12 10.5Z" fill="currentColor"/>
  </svg>
);
IconMailIcon.displayName = 'IconMailIcon';

export const IconReply = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M10 8V4L3 11L10 18V13.9C15 13.9 18.5 15.5 21 19C20 14 17 9 10 8Z" fill="currentColor"/>
  </svg>
);
IconReply.displayName = 'IconReply';

export const IconSave = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M17 2H5C3.89 2 3 2.9 3 4V18C3 19.1 3.89 20 5 20H19C20.1 20 21 19.1 21 18V6L17 2ZM19 18H5V4H16.17L19 6.83V18ZM12 11C10.34 11 9 12.34 9 14C9 15.66 10.34 17 12 17C13.66 17 15 15.66 15 14C15 12.34 13.66 11 12 11ZM6 5H15V9H6V5Z" fill="currentColor"/>
  </svg>
);
IconSave.displayName = 'IconSave';

export const IconSend = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M3.67124 19.9L21.1212 12.42C21.9312 12.07 21.9312 10.93 21.1212 10.58L3.67124 3.10002C3.01124 2.81002 2.28124 3.30002 2.28124 4.01002L2.27124 8.62002C2.27124 9.12002 2.64124 9.55002 3.14124 9.61002L17.2712 11.5L3.14124 13.38C2.64124 13.45 2.27124 13.88 2.27124 14.38L2.28124 18.99C2.28124 19.7 3.01124 20.19 3.67124 19.9Z" fill="currentColor"/>
  </svg>
);
IconSend.displayName = 'IconSend';

export const IconChatIcon = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M15 3.5V10.5H5.17L4 11.67V3.5H15ZM16 1.5H3C2.45 1.5 2 1.95 2 2.5V16.5L6 12.5H16C16.55 12.5 17 12.05 17 11.5V2.5C17 1.95 16.55 1.5 16 1.5ZM21 5.5H19V14.5H6V16.5C6 17.05 6.45 17.5 7 17.5H18L22 21.5V6.5C22 5.95 21.55 5.5 21 5.5Z" fill="currentColor"/>
  </svg>
);
IconChatIcon.displayName = 'IconChatIcon';

export const IconComment = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M21.99 3.5C21.99 2.4 21.1 1.5 20 1.5H4C2.9 1.5 2 2.4 2 3.5V15.5C2 16.6 2.9 17.5 4 17.5H18L22 21.5L21.99 3.5ZM17 13.5H7C6.45 13.5 6 13.05 6 12.5C6 11.95 6.45 11.5 7 11.5H17C17.55 11.5 18 11.95 18 12.5C18 13.05 17.55 13.5 17 13.5ZM17 10.5H7C6.45 10.5 6 10.05 6 9.5C6 8.95 6.45 8.5 7 8.5H17C17.55 8.5 18 8.95 18 9.5C18 10.05 17.55 10.5 17 10.5ZM17 7.5H7C6.45 7.5 6 7.05 6 6.5C6 5.95 6.45 5.5 7 5.5H17C17.55 5.5 18 5.95 18 6.5C18 7.05 17.55 7.5 17 7.5Z" fill="currentColor"/>
  </svg>
);
IconComment.displayName = 'IconComment';

export const IconEditTableIcon = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconEditTableRow = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconDelete = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M16.0004 8V18H8.0004V8H16.0004ZM14.5004 2H9.5004L8.5004 3H5.0004V5H19.0004V3H15.5004L14.5004 2ZM18.0004 6H6.0004V18C6.0004 19.1 6.9004 20 8.0004 20H16.0004C17.1004 20 18.0004 19.1 18.0004 18V6Z" fill="currentColor"/>
  </svg>
);
IconDelete.displayName = 'IconDelete';

export const IconOrganisationIcon = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconDetailsIcons = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M18 5H6C4.89543 5 4 5.89543 4 7V15C4 16.1046 4.89543 17 6 17H18C19.1046 17 20 16.1046 20 15V7C20 5.89543 19.1046 5 18 5ZM6 3C3.79086 3 2 4.79086 2 7V15C2 17.2091 3.79086 19 6 19H18C20.2091 19 22 17.2091 22 15V7C22 4.79086 20.2091 3 18 3H6Z" fill="currentColor"/>
<path d="M9 8.5C9 9.32843 8.32843 10 7.5 10C6.67157 10 6 9.32843 6 8.5C6 7.67157 6.67157 7 7.5 7C8.32843 7 9 7.67157 9 8.5Z" fill="currentColor"/>
<path d="M9 13.5C9 14.3284 8.32843 15 7.5 15C6.67157 15 6 14.3284 6 13.5C6 12.6716 6.67157 12 7.5 12C8.32843 12 9 12.6716 9 13.5Z" fill="currentColor"/>
<path d="M11 8.5C11 7.67157 11.6716 7 12.5 7H16.5C17.3284 7 18 7.67157 18 8.5C18 9.32843 17.3284 10 16.5 10H12.5C11.6716 10 11 9.32843 11 8.5Z" fill="currentColor"/>
<path d="M11 13.5C11 12.6716 11.6716 12 12.5 12H16.5C17.3284 12 18 12.6716 18 13.5C18 14.3284 17.3284 15 16.5 15H12.5C11.6716 15 11 14.3284 11 13.5Z" fill="currentColor"/>
  </svg>
);
IconDetailsIcons.displayName = 'IconDetailsIcons';

export const IconUserGroups = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconForeignKey = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M5.00049 16.25L7.00049 14.25L9.00049 16.25L11.0005 14.25H11.3511C12.171 16.5799 14.3906 18.2499 17.0005 18.25C20.0565 18.25 22.5847 15.9569 22.9546 13C22.9853 13.2456 23.0005 13.4962 23.0005 13.75C23.0005 17.06 20.3105 19.75 17.0005 19.75C14.3906 19.7499 12.171 18.0799 11.3511 15.75H11.0005L9.00049 17.75L7.00049 15.75L5.00049 17.75L1.00049 13.71L1.75439 12.9717L5.00049 16.25ZM17.0005 3.25C20.3105 3.25 23.0005 5.94 23.0005 9.25C23.0005 12.56 20.3105 15.25 17.0005 15.25C14.3905 15.25 12.1701 13.58 11.3501 11.25H11.0005L9.00049 13.25L7.00049 11.25L5.00049 13.25L1.00049 9.20996L3.00049 7.25H11.3501C12.1701 4.92 14.3905 3.25 17.0005 3.25ZM17.0005 6.25C15.3505 6.25 14.0005 7.6 14.0005 9.25C14.0005 10.9 15.3505 12.25 17.0005 12.25C18.6505 12.25 20.0005 10.9 20.0005 9.25C20.0005 7.6 18.6505 6.25 17.0005 6.25Z" fill="currentColor"/>
  </svg>
);
IconForeignKey.displayName = 'IconForeignKey';

export const IconBlockCancelled = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconHourglassRunning = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M18 1.5V7.5H17.9902L18 7.50977L14 11.5L18 15.5L17.9902 15.5098H18V21.5H6V15.5098H6.00977L6 15.5L10 11.5L6 7.50977L6.00977 7.5H6V1.5H18ZM8 16V19.5H16V16L12 12L8 16ZM8 3.5V7L12 11L16 7V3.5H8ZM13.7998 5.90039V6.5752L12 8.375L10.2002 6.5752V5.90039H13.7998Z" fill="currentColor"/>
  </svg>
);
IconHourglassRunning.displayName = 'IconHourglassRunning';

export const IconCheckCircleDone = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconWarning = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconAiIcon = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M4.97491 1.5L5.94265 3.50717L7.94982 4.47491L5.94265 5.44265L4.97491 7.44982L4.00717 5.44265L2 4.47491L4.00717 3.50717L4.97491 1.5ZM5.97849 15.5502L6.94624 17.5573L8.9534 18.5251L6.94624 19.4928L5.97849 21.5L5.01075 19.4928L3.00358 18.5251L5.01075 17.5573L5.97849 15.5502Z" fill="currentColor"/>
<path fillRule="evenodd" clipRule="evenodd" d="M16.0698 8.60531L13.0036 1.5L9.93732 8.60531L4.00717 11.5C4.00717 11.5 5.02792 12.0266 6.24014 12.6356C7.6464 13.3421 9.31033 14.1595 9.93732 14.3947C10.179 15.1195 11.118 17.2751 11.894 19.0236C12.4982 20.3852 13.0036 21.5 13.0036 21.5L16.0698 14.3947L22 11.5L16.0698 8.60531ZM17.4407 11.5L15.1925 10.4026C14.7631 10.193 14.4229 9.83653 14.2335 9.39776L13.0036 6.54765L11.7736 9.39776C11.5843 9.83653 11.2441 10.193 10.8146 10.4026L8.50695 11.5291C9.47219 12.003 10.3012 12.3951 10.6396 12.5221C11.2047 12.734 11.6438 13.1897 11.8347 13.7621C11.9722 14.1748 12.4337 15.2702 12.976 16.5163L14.2335 13.6022C14.4229 13.1635 14.7631 12.807 15.1925 12.5974L17.4407 11.5Z" fill="currentColor"/>
  </svg>
);
IconAiIcon.displayName = 'IconAiIcon';

export const IconAiKnowledge = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M7.25 20.5H11.25C11.25 21.6 10.35 22.5 9.25 22.5C8.15 22.5 7.25 21.6 7.25 20.5ZM5.25 19.5H13.25V17.5H5.25V19.5ZM16.75 10C16.75 13.82 14.09 15.86 12.98 16.5H5.52C4.41 15.86 1.75 13.82 1.75 10C1.75 5.86 5.11 2.5 9.25 2.5C13.39 2.5 16.75 5.86 16.75 10ZM14.75 10C14.75 6.97 12.28 4.5 9.25 4.5C6.22 4.5 3.75 6.97 3.75 10C3.75 12.47 5.24 13.89 6.1 14.5H12.4C13.26 13.89 14.75 12.47 14.75 10ZM19.62 7.87L18.25 8.5L19.62 9.13L20.25 10.5L20.88 9.13L22.25 8.5L20.88 7.87L20.25 6.5L19.62 7.87ZM18.25 6.5L19.19 4.44L21.25 3.5L19.19 2.56L18.25 0.5L17.31 2.56L15.25 3.5L17.31 4.44L18.25 6.5Z" fill="currentColor"/>
  </svg>
);
IconAiKnowledge.displayName = 'IconAiKnowledge';

export const IconAiInsights = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M3 10C3 9.72386 3.22386 9.5 3.5 9.5H5.5C5.77614 9.5 6 9.72386 6 10V22C6 22.2761 5.77614 22.5 5.5 22.5H3.5C3.22386 22.5 3 22.2761 3 22V10ZM8 7C8 6.72386 8.22386 6.5 8.5 6.5H10.5C10.7761 6.5 11 6.72386 11 7V22C11 22.2761 10.7761 22.5 10.5 22.5H8.5C8.22386 22.5 8 22.2761 8 22V7ZM13 13C13 12.7239 13.2239 12.5 13.5 12.5H15.5C15.7761 12.5 16 12.7239 16 13V22C16 22.2761 15.7761 22.5 15.5 22.5H13.5C13.2239 22.5 13 22.2761 13 22V13Z" fill="currentColor"/>
<path d="M21 18C21 17.7239 20.7761 17.5 20.5 17.5H18.5C18.2239 17.5 18 17.7239 18 18V22C18 22.2761 18.2239 22.5 18.5 22.5H20.5C20.7761 22.5 21 22.2761 21 22V18Z" fill="currentColor"/>
<path d="M12 5L14.4033 6.09667L15.5 8.5L16.5967 6.09667L19 5L16.5967 3.90333L15.5 1.5L14.4033 3.90333L12 5Z" fill="currentColor"/>
<path d="M18.7167 9.21667L19.5 7.5L20.2833 9.21667L22 10L20.2833 10.7833L19.5 12.5L18.7167 10.7833L17 10L18.7167 9.21667Z" fill="currentColor"/>
<path d="M10.13 1.87L9.5 0.5L8.87 1.87L7.5 2.5L8.87 3.13L9.5 4.5L10.13 3.13L11.5 2.5L10.13 1.87Z" fill="currentColor"/>
  </svg>
);
IconAiInsights.displayName = 'IconAiInsights';

export const IconDataProductIcon = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconPerformance = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M16 5L18.29 7.29L13.41 12.17L9.41 8.17L2 15.59L3.41 17L9.41 11L13.41 15L19.71 8.71L22 11V5H16Z" fill="currentColor"/>
  </svg>
);
IconPerformance.displayName = 'IconPerformance';

export const IconCollections = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M4.12891 5.12891C4.04535 5.40458 4.00004 5.69705 4 6V16C4 17.6569 5.34315 19 7 19H17C17.3029 19 17.5954 18.9556 17.8711 18.8721C17.4976 20.1038 16.3537 21 15 21H7C4.23858 21 2 18.7614 2 16V8C2.00016 6.64639 2.89717 5.50223 4.12891 5.12891ZM19 1C20.6569 1 22 2.34315 22 4V14C22 15.6569 20.6569 17 19 17H9C7.34315 17 6 15.6569 6 14V4C6 2.34315 7.34315 1 9 1H19ZM9 3C8.44772 3 8 3.44772 8 4V14C8 14.5523 8.44772 15 9 15H19C19.5523 15 20 14.5523 20 14V4C20 3.44772 19.5523 3 19 3H9ZM15 8H18.5V10H15V13.5H13V10H9.5V8H13V4.5H15V8Z" fill="currentColor"/>
  </svg>
);
IconCollections.displayName = 'IconCollections';

export const IconConfig = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconReviewerTasks = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M21 4.18L9.59 15.6L5.35 11.36L6.76 9.95L9.59 12.78L19.59 2.78L21 4.18ZM11 19C6.59 19 3 15.41 3 11C3 6.59 6.59 3 11 3C12.57 3 14.04 3.46 15.28 4.25L16.73 2.8C15.1 1.67 13.13 1 11 1C5.48 1 1 5.48 1 11C1 16.52 5.48 21 11 21C12.73 21 14.36 20.56 15.78 19.78L14.28 18.28C13.28 18.74 12.17 19 11 19ZM18 14H15V16H18V19H20V16H23V14H20V11H18V14Z" fill="currentColor"/>
  </svg>
);
IconReviewerTasks.displayName = 'IconReviewerTasks';

export const IconChatHistory = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M19.5 1.5C20.6 1.5 21.5 2.4 21.5 3.5V10.7559C20.8959 10.3344 20.2225 10.0061 19.5 9.79102V3.5H3.5V16.6699L4.66992 15.5H10.5723C10.5255 15.8267 10.5 16.1604 10.5 16.5C10.5 16.8396 10.5255 17.1733 10.5723 17.5H5.5L1.5 21.5L1.50977 3.5C1.50977 2.4 2.4 1.5 3.5 1.5H19.5Z" fill="currentColor"/>
<path d="M17.5 11.5C14.74 11.5 12.5 13.74 12.5 16.5C12.5 19.26 14.74 21.5 17.5 21.5C20.26 21.5 22.5 19.26 22.5 16.5C22.5 13.74 20.26 11.5 17.5 11.5ZM19.15 18.85L17 16.7V13.5H18V16.29L19.85 18.14L19.15 18.85Z" fill="currentColor"/>
  </svg>
);
IconChatHistory.displayName = 'IconChatHistory';

export const IconShareIcon = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconAnalyse = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M22.5 19.09L17.81 14.4C18.87 13.05 19.5 11.35 19.5 9.5C19.5 5.08 15.92 1.5 11.5 1.5C7.42 1.5 4.06 4.55 3.57 8.5H5.59C6.07 5.67 8.53 3.5 11.5 3.5C14.81 3.5 17.5 6.19 17.5 9.5C17.5 12.81 14.81 15.5 11.5 15.5C9.08 15.5 7 14.06 6.05 12H3.9C4.95 15.19 7.96 17.5 11.5 17.5C13.35 17.5 15.05 16.87 16.4 15.81L21.09 20.5L22.5 19.09Z" fill="currentColor"/>
<path d="M8.93 8.19L10.15 13.5H11.79L13.05 9.72L14 12H16V10.5H15L13.75 7.5H12.21L11.09 10.87L9.85 5.5H8.2L6.95 9.5H1.5V11H8.05L8.93 8.19Z" fill="currentColor"/>
  </svg>
);
IconAnalyse.displayName = 'IconAnalyse';

export const IconCollectionsAlt = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M4.12891 5.12891C4.04535 5.40458 4.00004 5.69705 4 6V16C4 17.6569 5.34315 19 7 19H17C17.3029 19 17.5954 18.9556 17.8711 18.8721C17.4976 20.1038 16.3537 21 15 21H7C4.23858 21 2 18.7614 2 16V8C2.00016 6.64639 2.89717 5.50223 4.12891 5.12891ZM19 1C20.6569 1 22 2.34315 22 4V14C22 15.6569 20.6569 17 19 17H9C7.34315 17 6 15.6569 6 14V4C6 2.34315 7.34315 1 9 1H19ZM9 3C8.44772 3 8 3.44772 8 4V14C8 14.5523 8.44772 15 9 15H19C19.5523 15 20 14.5523 20 14V4C20 3.44772 19.5523 3 19 3H9Z" fill="currentColor"/>
  </svg>
);
IconCollectionsAlt.displayName = 'IconCollectionsAlt';

export const IconReviewerTasksAlt = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M22 4.18L10.59 15.6L6.35 11.36L7.76 9.95L10.59 12.78L20.59 2.78L22 4.18ZM12 19C7.59 19 4 15.41 4 11C4 6.59 7.59 3 12 3C13.57 3 15.04 3.46 16.28 4.25L17.73 2.8C16.1 1.67 14.13 1 12 1C6.48 1 2 5.48 2 11C2 16.52 6.48 21 12 21C13.73 21 15.36 20.56 16.78 19.78L15.28 18.28C14.28 18.74 13.17 19 12 19Z" fill="currentColor"/>
<path d="M20 11C20 15.41 16.41 19 12 19C7.59 19 4 15.41 4 11C4 9.43 4.46 7.96 5.25 6.72L3.8 5.27C2.67 6.9 2 8.87 2 11C2 16.52 6.48 21 12 21C17.52 21 22 16.52 22 11C22 10.0205 21.859 9.07315 21.595 8.17776C21.2728 8.5 20.2725 9.5 19.9445 10.0681C19.9811 10.3737 20 10.6847 20 11Z" fill="currentColor"/>
  </svg>
);
IconReviewerTasksAlt.displayName = 'IconReviewerTasksAlt';

export const IconPollyScout = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconPendingTasks = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M20 11C20 6.58172 16.4183 3 12 3C7.58172 3 4 6.58172 4 11C4 15.4183 7.58172 19 12 19V21C6.47715 21 2 16.5228 2 11C2 5.47715 6.47715 1 12 1C17.5228 1 22 5.47715 22 11C22 16.5228 17.5228 21 12 21V19C16.4183 19 20 15.4183 20 11Z" fill="currentColor"/>
  </svg>
);
IconPendingTasks.displayName = 'IconPendingTasks';

export const IconPollyXtract = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconLogout = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M17 7.5L15.59 8.91L17.17 10.5H9V12.5H17.17L15.59 14.08L17 15.5L21 11.5L17 7.5ZM5 4.5H12V2.5H5C3.9 2.5 3 3.4 3 4.5V18.5C3 19.6 3.9 20.5 5 20.5H12V18.5H5V4.5Z" fill="currentColor"/>
  </svg>
);
IconLogout.displayName = 'IconLogout';

export const IconLogin = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M11 6.5L9.6 7.9L12.2 10.5H2V12.5H12.2L9.6 15.1L11 16.5L16 11.5L11 6.5ZM20 18.5H12V20.5H20C21.1 20.5 22 19.6 22 18.5V4.5C22 3.4 21.1 2.5 20 2.5H12V4.5H20V18.5Z" fill="currentColor"/>
  </svg>
);
IconLogin.displayName = 'IconLogin';

export const IconMic = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconMicOff = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconAiInsight = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M12.5 20.5C12.5 21.6 11.6 22.5 10.5 22.5C9.4 22.5 8.5 21.6 8.5 20.5H12.5Z" fill="currentColor"/>
<path d="M14.5 19.5H6.5V17.5H14.5V19.5Z" fill="currentColor"/>
<path d="M10.5 2.5C11.5812 2.5 12.6083 2.73119 13.5371 3.14355L10.5625 4.50098C10.5417 4.50074 10.5209 4.5 10.5 4.5C7.47 4.5 5 6.97 5 10C5 12.4698 6.48957 13.8899 7.34961 14.5H13.6504C14.0558 14.2124 14.5983 13.7429 15.0615 13.0703L15.9824 15.0889C15.3283 15.7859 14.6631 16.2505 14.2305 16.5H6.76953C5.65932 15.8598 3 13.8196 3 10C3 5.86 6.36 2.5 10.5 2.5Z" fill="currentColor"/>
<path d="M18.8799 4.62012L23 6.5L18.8799 8.37988L17 12.5L15.1201 8.37988L11 6.5L15.1201 4.62012L15.2949 4.23535L17 0.5L18.8799 4.62012Z" fill="currentColor"/>
  </svg>
);
IconAiInsight.displayName = 'IconAiInsight';

export const IconPollyKG = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconVideo = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M15 11.5L9 15.5V7.5L15 11.5Z" fill="currentColor"/>
<path fillRule="evenodd" clipRule="evenodd" d="M21 3.5C22.1 3.5 23 4.4 23 5.5V17.5C23 18.6 22.1 19.5 21 19.5H3C1.9 19.5 1 18.6 1 17.5V5.5C1 4.4 1.9 3.5 3 3.5H21ZM3 17.5H21V5.5H3V17.5Z" fill="currentColor"/>
  </svg>
);
IconVideo.displayName = 'IconVideo';

export const IconFiles = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M14 1.5H6C4.9 1.5 4.01 2.4 4.01 3.5L4 19.5C4 20.6 4.89 21.5 5.99 21.5H18C19.1 21.5 20 20.6 20 19.5V7.5L14 1.5ZM6 19.5V3.5H13V8.5H18V19.5H6Z" fill="currentColor"/>
  </svg>
);
IconFiles.displayName = 'IconFiles';

export const IconAudio = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M12 2.5V13.05C11.41 12.71 10.73 12.5 10 12.5C7.79 12.5 6 14.29 6 16.5C6 18.71 7.79 20.5 10 20.5C12.21 20.5 14 18.71 14 16.5V6.5H18V2.5H12ZM10 18.5C8.9 18.5 8 17.6 8 16.5C8 15.4 8.9 14.5 10 14.5C11.1 14.5 12 15.4 12 16.5C12 17.6 11.1 18.5 10 18.5Z" fill="currentColor"/>
  </svg>
);
IconAudio.displayName = 'IconAudio';

export const IconCamera = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M15 7.5V15.5H5V7.5H15ZM16 5.5H4C3.45 5.5 3 5.95 3 6.5V16.5C3 17.05 3.45 17.5 4 17.5H16C16.55 17.5 17 17.05 17 16.5V13L21 17V6L17 10V6.5C17 5.95 16.55 5.5 16 5.5Z" fill="currentColor"/>
  </svg>
);
IconCamera.displayName = 'IconCamera';

export const IconImages = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M19 4.5V18.5H5V4.5H19ZM19 2.5H5C3.9 2.5 3 3.4 3 4.5V18.5C3 19.6 3.9 20.5 5 20.5H19C20.1 20.5 21 19.6 21 18.5V4.5C21 3.4 20.1 2.5 19 2.5ZM14.14 11.36L11.14 15.23L9 12.64L6 16.5H18L14.14 11.36Z" fill="currentColor"/>
  </svg>
);
IconImages.displayName = 'IconImages';

export const IconPollyPipelinesAlt = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconCoScientistIcon = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M13.7422 14.9899C14.9047 14.3249 16.292 14.3974 17.3545 15.0592L22.4785 17.9948L17.2393 20.9918C15.5667 21.9487 13.4276 21.3806 12.4619 19.7233C12.1904 19.2572 12.0408 18.7546 12.0029 18.2516L11.9961 18.1373L11.9941 23.9996L6.75488 21.0026C5.08228 20.0457 4.50893 17.9265 5.47461 16.2692C6.44031 14.6119 8.57938 14.0438 10.252 15.0006C11.328 15.6163 11.9473 16.7136 11.9961 17.859C12.0414 16.7097 12.6626 15.6075 13.7422 14.9899Z" fill="currentColor"/>
<path d="M4.99707 8.53675C6.92826 8.53678 8.49392 10.0881 8.49414 12.0016C8.49414 13.3334 7.73513 14.4889 6.62305 15.069L1.5 17.9967V12.0016C1.50022 10.088 3.06585 8.53675 4.99707 8.53675Z" fill="currentColor"/>
<path d="M22.5 11.9977L22.4951 12.1764C22.4014 14.0072 20.8739 15.4635 19.0029 15.4635C17.0716 15.4635 15.5059 13.9114 15.5059 11.9977C15.506 10.6619 16.2691 9.50269 17.3867 8.92444L22.5 6.00355V11.9977Z" fill="currentColor"/>
<path d="M6.91895 2.92249C8.56589 2.0876 10.6026 2.67057 11.5381 4.27601C12.5037 5.93327 11.9302 8.05247 10.2578 9.00941C9.09496 9.67465 7.70716 9.60252 6.64453 8.94007L1.52148 6.0055L6.76074 3.00843L6.91895 2.92249Z" fill="currentColor"/>
<path d="M17.2451 2.99707C18.9176 3.9539 19.4909 6.07315 18.5254 7.73047C17.5597 9.38781 15.4206 9.95589 13.748 8.99902C12.7551 8.43085 12.1503 7.45286 12.0244 6.40527L12.0049 6.19531C11.8873 4.18037 11.9818 2.70113 12 0.47168V0L12.0049 0.00292969L12.0058 0C14.0385 1.16285 17.2036 2.97336 17.2451 2.99707ZM13.5039 3.87988C13.5036 4.48312 13.5031 5.01327 13.5029 5.39258V6.00098H13.498C13.5 6.03624 13.5008 6.07176 13.5029 6.10742C13.5401 6.74447 13.8887 7.35142 14.4931 7.69727C15.4563 8.24825 16.6817 7.91563 17.2295 6.97559C17.7385 6.10187 17.4919 4.99441 16.6719 4.40918L16.501 4.2998L13.5039 2.58691C13.5037 3.03512 13.5041 3.47425 13.5039 3.87988Z" fill="currentColor"/>
  </svg>
);
IconCoScientistIcon.displayName = 'IconCoScientistIcon';

export const IconYoutubeSearchedFor = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconFilter = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M7.00457 5H17.0046L11.9946 11.3L7.00457 5ZM4.25457 4.61C6.27457 7.2 10.0046 12 10.0046 12V18C10.0046 18.55 10.4546 19 11.0046 19H13.0046C13.5546 19 14.0046 18.55 14.0046 18V12C14.0046 12 17.7246 7.2 19.7446 4.61C20.2546 3.95 19.7846 3 18.9546 3H5.04457C4.21457 3 3.74457 3.95 4.25457 4.61Z" fill="currentColor"/>
  </svg>
);
IconFilter.displayName = 'IconFilter';

export const IconZoomIn = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconAddCircle = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M12 1.5C6.48 1.5 2 5.98 2 11.5C2 17.02 6.48 21.5 12 21.5C17.52 21.5 22 17.02 22 11.5C22 5.98 17.52 1.5 12 1.5ZM17 12.5H13V16.5H11V12.5H7V10.5H11V6.5H13V10.5H17V12.5Z" fill="currentColor"/>
  </svg>
);
IconAddCircle.displayName = 'IconAddCircle';

export const IconAddCircleOutline = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M13 6.5H11V10.5H7V12.5H11V16.5H13V12.5H17V10.5H13V6.5ZM12 1.5C6.48 1.5 2 5.98 2 11.5C2 17.02 6.48 21.5 12 21.5C17.52 21.5 22 17.02 22 11.5C22 5.98 17.52 1.5 12 1.5ZM12 19.5C7.59 19.5 4 15.91 4 11.5C4 7.09 7.59 3.5 12 3.5C16.41 3.5 20 7.09 20 11.5C20 15.91 16.41 19.5 12 19.5Z" fill="currentColor"/>
  </svg>
);
IconAddCircleOutline.displayName = 'IconAddCircleOutline';

export const IconRemove = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M19 12.5H5V10.5H19V12.5Z" fill="currentColor"/>
  </svg>
);
IconRemove.displayName = 'IconRemove';

export const IconRemoveCircle = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M12 1.5C6.48 1.5 2 5.98 2 11.5C2 17.02 6.48 21.5 12 21.5C17.52 21.5 22 17.02 22 11.5C22 5.98 17.52 1.5 12 1.5ZM17 12.5H7V10.5H17V12.5Z" fill="currentColor"/>
  </svg>
);
IconRemoveCircle.displayName = 'IconRemoveCircle';

export const IconRemoveCircleOutline = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M7 10.5V12.5H17V10.5H7ZM12 1.5C6.48 1.5 2 5.98 2 11.5C2 17.02 6.48 21.5 12 21.5C17.52 21.5 22 17.02 22 11.5C22 5.98 17.52 1.5 12 1.5ZM12 19.5C7.59 19.5 4 15.91 4 11.5C4 7.09 7.59 3.5 12 3.5C16.41 3.5 20 7.09 20 11.5C20 15.91 16.41 19.5 12 19.5Z" fill="currentColor"/>
  </svg>
);
IconRemoveCircleOutline.displayName = 'IconRemoveCircleOutline';

export const IconPlayArrow = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M6.92749 6.31976V16.6798C6.92749 17.4698 7.79749 17.9498 8.46749 17.5198L16.6075 12.3398C17.2275 11.9498 17.2275 11.0498 16.6075 10.6498L8.46749 5.47976C7.79749 5.04976 6.92749 5.52976 6.92749 6.31976Z" fill="currentColor"/>
  </svg>
);
IconPlayArrow.displayName = 'IconPlayArrow';

export const IconPause = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M8 18.5C9.1 18.5 10 17.6 10 16.5V6.5C10 5.4 9.1 4.5 8 4.5C6.9 4.5 6 5.4 6 6.5V16.5C6 17.6 6.9 18.5 8 18.5ZM14 6.5V16.5C14 17.6 14.9 18.5 16 18.5C17.1 18.5 18 17.6 18 16.5V6.5C18 5.4 17.1 4.5 16 4.5C14.9 4.5 14 5.4 14 6.5Z" fill="currentColor"/>
  </svg>
);
IconPause.displayName = 'IconPause';

export const IconStop = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M8 5.5H16C17.1 5.5 18 6.4 18 7.5V15.5C18 16.6 17.1 17.5 16 17.5H8C6.9 17.5 6 16.6 6 15.5V7.5C6 6.4 6.9 5.5 8 5.5Z" fill="currentColor"/>
  </svg>
);
IconStop.displayName = 'IconStop';

export const IconAdd = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M19.0004 12H13.0004V18H11.0004V12H5.00037V10H11.0004V4H13.0004V10H19.0004V12Z" fill="currentColor"/>
  </svg>
);
IconAdd.displayName = 'IconAdd';

export const IconPlayCircle = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M12 1.5C6.48 1.5 2 5.98 2 11.5C2 17.02 6.48 21.5 12 21.5C17.52 21.5 22 17.02 22 11.5C22 5.98 17.52 1.5 12 1.5ZM9.5 14.17V8.83C9.5 8.04 10.38 7.56 11.04 7.99L15.19 10.66C15.8 11.05 15.8 11.95 15.19 12.34L11.04 15.01C10.38 15.44 9.5 14.96 9.5 14.17Z" fill="currentColor"/>
  </svg>
);
IconPlayCircle.displayName = 'IconPlayCircle';

export const IconPauseCircle = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconStopCircle = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M12 1.5C6.48 1.5 2 5.98 2 11.5C2 17.02 6.48 21.5 12 21.5C17.52 21.5 22 17.02 22 11.5C22 5.98 17.52 1.5 12 1.5ZM15 15.5H9C8.45 15.5 8 15.05 8 14.5V8.5C8 7.95 8.45 7.5 9 7.5H15C15.55 7.5 16 7.95 16 8.5V14.5C16 15.05 15.55 15.5 15 15.5Z" fill="currentColor"/>
  </svg>
);
IconStopCircle.displayName = 'IconStopCircle';

export const IconReplay = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M12 5.5V1.5L7 6.5L12 11.5V7.5C15.31 7.5 18 10.19 18 13.5C18 16.81 15.31 19.5 12 19.5C8.69 19.5 6 16.81 6 13.5H4C4 17.92 7.58 21.5 12 21.5C16.42 21.5 20 17.92 20 13.5C20 9.08 16.42 5.5 12 5.5Z" fill="currentColor"/>
  </svg>
);
IconReplay.displayName = 'IconReplay';

export const IconLoopRefreshUpdate = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M12 3.5V0.5L8 4.5L12 8.5V5.5C15.31 5.5 18 8.19 18 11.5C18 12.51 17.75 13.47 17.3 14.3L18.76 15.76C19.54 14.53 20 13.07 20 11.5C20 7.08 16.42 3.5 12 3.5ZM12 17.5C8.69 17.5 6 14.81 6 11.5C6 10.49 6.25 9.53 6.7 8.7L5.24 7.24C4.46 8.47 4 9.93 4 11.5C4 15.92 7.58 19.5 12 19.5V22.5L16 18.5L12 14.5V17.5Z" fill="currentColor"/>
  </svg>
);
IconLoopRefreshUpdate.displayName = 'IconLoopRefreshUpdate';

export const IconForward = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M12 5.5V1.5L17 6.5L12 11.5V7.5C8.69 7.5 6 10.19 6 13.5C6 16.81 8.69 19.5 12 19.5C15.31 19.5 18 16.81 18 13.5H20C20 17.92 16.42 21.5 12 21.5C7.58 21.5 4 17.92 4 13.5C4 9.08 7.58 5.5 12 5.5Z" fill="currentColor"/>
  </svg>
);
IconForward.displayName = 'IconForward';

export const IconContract = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M22.0004 2.41L16.7104 7.7L20.0004 11H12.0004V3L15.2904 6.29L20.5904 1L22.0004 2.41ZM3.41039 21L8.70039 15.71L12.0004 19V11H4.00039L7.29039 14.29L2.00039 19.59L3.41039 21Z" fill="currentColor"/>
  </svg>
);
IconContract.displayName = 'IconContract';

export const IconExpand = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M10.59 11L5.3 16.29L2 13L2 21L10 21L6.71 17.71L12 12.41L10.59 11Z" fill="currentColor"/>
<path d="M13.41 11L18.7 5.71L22 9V1H14L17.29 4.29L12 9.59L13.41 11Z" fill="currentColor"/>
  </svg>
);
IconExpand.displayName = 'IconExpand';

export const IconClose = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M19.0004 5.41L17.5904 4L12.0004 9.59L6.4104 4L5.0004 5.41L10.5904 11L5.0004 16.59L6.4104 18L12.0004 12.41L17.5904 18L19.0004 16.59L13.4104 11L19.0004 5.41Z" fill="currentColor"/>
  </svg>
);
IconClose.displayName = 'IconClose';

export const IconUpChevron = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M12 7.29498L6 13.295L7.41 14.705L12 10.125L16.59 14.705L18 13.295L12 7.29498Z" fill="currentColor"/>
  </svg>
);
IconUpChevron.displayName = 'IconUpChevron';

export const IconLeftChevron = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M15 15.59L10.42 11L15 6.41L13.59 5L7.59 11L13.59 17L15 15.59Z" fill="currentColor"/>
  </svg>
);
IconLeftChevron.displayName = 'IconLeftChevron';

export const IconRightChevron = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M9 6.41L13.58 11L9 15.59L10.41 17L16.41 11L10.41 5L9 6.41Z" fill="currentColor"/>
  </svg>
);
IconRightChevron.displayName = 'IconRightChevron';

export const IconExpandChevron = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M16.59 7.29498L12 11.875L7.41 7.29498L6 8.70498L12 14.705L18 8.70498L16.59 7.29498Z" fill="currentColor"/>
  </svg>
);
IconExpandChevron.displayName = 'IconExpandChevron';

export const IconUpCarrot = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M7 13.5L12 8.5L17 13.5H7Z" fill="currentColor"/>
  </svg>
);
IconUpCarrot.displayName = 'IconUpCarrot';

export const IconLeftCarrot = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M14.5 6L9.5 11L14.5 16V6Z" fill="currentColor"/>
  </svg>
);
IconLeftCarrot.displayName = 'IconLeftCarrot';

export const IconRightCarrot = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M9.5 16L14.5 11L9.5 6V16Z" fill="currentColor"/>
  </svg>
);
IconRightCarrot.displayName = 'IconRightCarrot';

export const IconDownCarrot = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M7 8.5L12 13.5L17 8.5H7Z" fill="currentColor"/>
  </svg>
);
IconDownCarrot.displayName = 'IconDownCarrot';

export const IconArrowUp = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M4.00079 11L5.41079 12.41L11.0008 6.83L11.0008 19L13.0008 19L13.0008 6.83L18.5808 12.42L20.0008 11L12.0008 3L4.00079 11Z" fill="currentColor"/>
  </svg>
);
IconArrowUp.displayName = 'IconArrowUp';

export const IconArrowLeftBack = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M20 10H7.83L13.42 4.41L12 3L4 11L12 19L13.41 17.59L7.83 12H20V10Z" fill="currentColor"/>
  </svg>
);
IconArrowLeftBack.displayName = 'IconArrowLeftBack';

export const IconArrowRightForward = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M12 3L10.59 4.41L16.17 10H4V12H16.17L10.59 17.59L12 19L20 11L12 3Z" fill="currentColor"/>
  </svg>
);
IconArrowRightForward.displayName = 'IconArrowRightForward';

export const IconArrowDown = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M20 11L18.59 9.59L13 15.17V3H11V15.17L5.42 9.58L4 11L12 19L20 11Z" fill="currentColor"/>
  </svg>
);
IconArrowDown.displayName = 'IconArrowDown';

export const IconNorthEast = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M9.5 3.5V5.5H16.09L4.5 17.09L5.91 18.5L17.5 6.91V13.5H19.5V3.5H9.5Z" fill="currentColor"/>
  </svg>
);
IconNorthEast.displayName = 'IconNorthEast';

export const IconNorthWest = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M4.5 13.5H6.5V6.91L18.09 18.5L19.5 17.09L7.91 5.5H14.5V3.5H4.5V13.5Z" fill="currentColor"/>
  </svg>
);
IconNorthWest.displayName = 'IconNorthWest';

export const IconSouthEast = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M19.5 8.5H17.5V15.09L5.91 3.5L4.5 4.91L16.09 16.5H9.5V18.5H19.5V8.5Z" fill="currentColor"/>
  </svg>
);
IconSouthEast.displayName = 'IconSouthEast';

export const IconSouthWest = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M14.5 18.5V16.5H7.91L19.5 4.91L18.09 3.5L6.5 15.09V8.5H4.5V18.5H14.5Z" fill="currentColor"/>
  </svg>
);
IconSouthWest.displayName = 'IconSouthWest';

export const IconArrowForwardLarge = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M6.115 19.23L7.885 21L17.885 11L7.885 1L6.115 2.77L14.345 11L6.115 19.23Z" fill="currentColor"/>
  </svg>
);
IconArrowForwardLarge.displayName = 'IconArrowForwardLarge';

export const IconArrowBackLarge = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M17.835 2.86998L16.055 1.09998L6.16499 11L16.065 20.9L17.835 19.13L9.70499 11L17.835 2.86998Z" fill="currentColor"/>
  </svg>
);
IconArrowBackLarge.displayName = 'IconArrowBackLarge';

export const IconSkipToFirst = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconFolderOpen = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M20.0004 4.99997H12.0004L10.0004 2.99997H4.0004C2.9004 2.99997 2.0104 3.89997 2.0104 4.99997L2.0004 17C2.0004 18.1 2.9004 19 4.0004 19H20.0004C21.1004 19 22.0004 18.1 22.0004 17V6.99997C22.0004 5.89997 21.1004 4.99997 20.0004 4.99997ZM20.0004 17H4.0004V6.99997H20.0004V17Z" fill="currentColor"/>
  </svg>
);
IconFolderOpen.displayName = 'IconFolderOpen';

export const IconFolder = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M9.17 5L11.17 7H20V17H4V5H9.17ZM10 3H4C2.9 3 2.01 3.9 2.01 5L2 17C2 18.1 2.9 19 4 19H20C21.1 19 22 18.1 22 17V7C22 5.9 21.1 5 20 5H12L10 3Z" fill="currentColor"/>
  </svg>
);
IconFolder.displayName = 'IconFolder';

export const IconCreateNewFolder = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M20 5H12L10 3H4C2.89 3 2.01 3.89 2.01 5L2 17C2 18.11 2.89 19 4 19H20C21.11 19 22 18.11 22 17V7C22 5.89 21.11 5 20 5ZM20 17H4V5H9.17L11.17 7H20V17ZM12 13H14V15H16V13H18V11H16V9H14V11H12V13Z" fill="currentColor"/>
  </svg>
);
IconCreateNewFolder.displayName = 'IconCreateNewFolder';

export const IconUploadFolder = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconLink = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M17 6H13V8H17C18.65 8 20 9.35 20 11C20 12.65 18.65 14 17 14H13V16H17C19.76 16 22 13.76 22 11C22 8.24 19.76 6 17 6ZM11 14H7C5.35 14 4 12.65 4 11C4 9.35 5.35 8 7 8H11V6H7C4.24 6 2 8.24 2 11C2 13.76 4.24 16 7 16H11V14ZM8 10H16V12H8V10Z" fill="currentColor"/>
  </svg>
);
IconLink.displayName = 'IconLink';

export const IconDone = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M20.13 6.39999L18.72 4.98999L9.52999 14.18L5.28 9.93999L3.87 11.35L9.52999 17.01L20.13 6.39999Z" fill="currentColor"/>
  </svg>
);
IconDone.displayName = 'IconDone';

export const IconChartIcon = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M3 6.5C3 6.22386 3.22386 6 3.5 6H5.5C5.77614 6 6 6.22386 6 6.5V18.5C6 18.7761 5.77614 19 5.5 19H3.5C3.22386 19 3 18.7761 3 18.5V6.5ZM8 3.5C8 3.22386 8.22386 3 8.5 3H10.5C10.7761 3 11 3.22386 11 3.5V18.5C11 18.7761 10.7761 19 10.5 19H8.5C8.22386 19 8 18.7761 8 18.5V3.5ZM13 9.5C13 9.22386 13.2239 9 13.5 9H15.5C15.7761 9 16 9.22386 16 9.5V18.5C16 18.7761 15.7761 19 15.5 19H13.5C13.2239 19 13 18.7761 13 18.5V9.5Z" fill="currentColor"/>
<path d="M21 14.5C21 14.2239 20.7761 14 20.5 14H18.5C18.2239 14 18 14.2239 18 14.5V18.5C18 18.7761 18.2239 19 18.5 19H20.5C20.7761 19 21 18.7761 21 18.5V14.5Z" fill="currentColor"/>
  </svg>
);
IconChartIcon.displayName = 'IconChartIcon';

export const IconDocument = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M8 15H16V17H8V15ZM8 11H16V13H8V11ZM14 1H6C4.9 1 4 1.9 4 3V19C4 20.1 4.89 21 5.99 21H18C19.1 21 20 20.1 20 19V7L14 1ZM18 19H6V3H13V8H18V19Z" fill="currentColor"/>
  </svg>
);
IconDocument.displayName = 'IconDocument';

export const IconCodeDocument = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M14 20.795L12.3245 19L14 17.205L13.3401 16.5L11 19L13.3401 21.5L14 20.795Z" fill="currentColor"/>
<path d="M15 21.7339L15.9609 16L17 16.2696L16.0255 22L15 21.7339Z" fill="currentColor"/>
<path d="M18 20.795L19.6755 19L18 17.205L18.6599 16.5L21 19L18.6599 21.5L18 20.795Z" fill="currentColor"/>
<path d="M10 15H8V17H10V15Z" fill="currentColor"/>
<path d="M18.25 15C18.1119 15 18 14.8881 18 14.75V8H13V3H6V19H9.75C9.88807 19 10 19.1119 10 19.25V20.75C10 20.8881 9.88807 21 9.75 21H5.99C4.89 21 4 20.1 4 19V3C4 1.9 4.9 1 6 1H14L20 7V14.75C20 14.8881 19.8881 15 19.75 15H18.25Z" fill="currentColor"/>
<path d="M16 11H8V13H16V11Z" fill="currentColor"/>
  </svg>
);
IconCodeDocument.displayName = 'IconCodeDocument';

export const IconInfo = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M11 6H13V8H11V6ZM11 10H13V16H11V10ZM12 1C6.48 1 2 5.48 2 11C2 16.52 6.48 21 12 21C17.52 21 22 16.52 22 11C22 5.48 17.52 1 12 1ZM12 19C7.59 19 4 15.41 4 11C4 6.59 7.59 3 12 3C16.41 3 20 6.59 20 11C20 15.41 16.41 19 12 19Z" fill="currentColor"/>
  </svg>
);
IconInfo.displayName = 'IconInfo';

export const IconSwap = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M3 12.5L2 13.5L6 17.5L7.41 16.09L5.83 14.5H21V12.5C21 12.5 11.7543 12.5 5.83 12.5C4.72482 12.5 4.02014 12.5 3 12.5Z" fill="currentColor"/>
<path d="M21 9.5L22 8.5L18 4.5L16.59 5.91L18.17 7.5H3V9.5H18.17H21Z" fill="currentColor"/>
  </svg>
);
IconSwap.displayName = 'IconSwap';

export const IconDescription = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconRename = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M15 15L11 19H21V15H15Z" fill="currentColor"/>
<path d="M12.06 6.19L3 15.25V19H6.75L15.81 9.94L12.06 6.19ZM5.92 17H5V16.08L12.06 9.02L12.98 9.94L5.92 17Z" fill="currentColor"/>
<path d="M18.71 7.04C19.1 6.65 19.1 6.02 18.71 5.63L16.37 3.29C16.17 3.09 15.92 3 15.66 3C15.41 3 15.15 3.1 14.96 3.29L13.13 5.12L16.88 8.87L18.71 7.04Z" fill="currentColor"/>
  </svg>
);
IconRename.displayName = 'IconRename';

export const IconPanMove = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconCuration = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M4 6.5H3L3 9.5H4L4 6.5ZM10 6.5H9V11.5H10V6.5ZM2 11.5H3L3 15.5H4L4 11.5H5V10.5H2L2 11.5ZM8 8.5H7V6.5H6V8.5H5L5 9.5H8V8.5ZM6 15.5H7V10.5H6L6 15.5ZM8 12.5V13.5H9V15.5H10V13.5H11V12.5H8Z" fill="currentColor"/>
<path fillRule="evenodd" clipRule="evenodd" d="M15.0858 1C15.351 1 15.6054 1.10536 15.7929 1.29289L21.2071 6.70711C21.3946 6.89464 21.5 7.149 21.5 7.41421V19C21.5 20.1 20.6 21 19.5 21H7.49C6.39 21 5.5 20.1 5.5 19V17H7.5V19H19.5V8H15.5C14.9477 8 14.5 7.55228 14.5 7V3H7.5V5H5.5V3C5.5 1.9 6.4 1 7.5 1H15.0858ZM16.5 4.5L18 6H16.5V4.5Z" fill="currentColor"/>
  </svg>
);
IconCuration.displayName = 'IconCuration';

export const IconHelpAndSupport = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconWorkspaces = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
  ...
  >
    <path d="M9.17 5L11.17 7H20V17H4V5H9.17ZM10 3H4C2.9 3 2.01 3.9 2.01 5L2 17C2 18.1 2.9 19 4 19H20C21.1 19 22 18.1 22 17V7C22 5.9 21.1 5 20 5H12L10 3Z" fill="currentColor"/>
<path d="M12 15.34L11.42 14.812C9.36 12.944 8 11.712 8 10.2C8 8.968 8.968 8 10.2 8C10.896 8 11.564 8.324 12 8.836C12.436 8.324 13.104 8 13.8 8C15.032 8 16 8.968 16 10.2C16 11.712 14.64 12.944 12.58 14.816L12 15.34Z" fill="currentColor"/>
  </svg>
);
IconWorkspaces.displayName = 'IconWorkspaces';

export const IconApplication = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconCostWallet = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M20.5 6.28V4C20.5 2.9 19.6 2 18.5 2H4.5C3.39 2 2.5 2.9 2.5 4V18C2.5 19.1 3.39 20 4.5 20H18.5C19.6 20 20.5 19.1 20.5 18V15.72C21.09 15.37 21.5 14.74 21.5 14V8C21.5 7.26 21.09 6.63 20.5 6.28ZM19.5 8V14H12.5V8H19.5ZM4.5 18V4H18.5V6H12.5C11.4 6 10.5 6.9 10.5 8V14C10.5 15.1 11.4 16 12.5 16H18.5V18H4.5Z" fill="currentColor"/>
<path d="M15.5 12.5C16.3284 12.5 17 11.8284 17 11C17 10.1716 16.3284 9.5 15.5 9.5C14.6716 9.5 14 10.1716 14 11C14 11.8284 14.6716 12.5 15.5 12.5Z" fill="currentColor"/>
  </svg>
);
IconCostWallet.displayName = 'IconCostWallet';

export const IconSplitView = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M12 20H10V19H4C3.44772 19 3 18.5523 3 18V4C3 3.44772 3.44772 3 4 3H10V2H12V20ZM20 3C20.5523 3 21 3.44772 21 4V18C21 18.5523 20.5523 19 20 19H14V17H19V5H14V3H20Z" fill="currentColor"/>
  </svg>
);
IconSplitView.displayName = 'IconSplitView';

export const IconSummaryView = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconTableView = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M3 5C3 3.34315 4.34315 2 6 2H18C19.6569 2 21 3.34315 21 5V17C21 18.6569 19.6569 20 18 20H6C4.34315 20 3 18.6569 3 17V5ZM5.00516 4.89776C5.05637 4.3935 5.48223 4 6 4H18C18.5523 4 19 4.44772 19 5V17C19 17.5523 18.5523 18 18 18H6C5.96548 18 5.93137 17.9983 5.89776 17.9948C5.3935 17.9436 5 17.5178 5 17V5C5 4.96548 5.00175 4.93137 5.00516 4.89776Z" fill="currentColor"/>
<path d="M8.55078 4H9.5H10.5508V18H8.55078V4Z" fill="currentColor"/>
<path d="M5 9.5V7.5L19 7.5V9.5L5 9.5Z" fill="currentColor"/>
  </svg>
);
IconTableView.displayName = 'IconTableView';

export const IconCancelRound = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M12 1C6.47 1 2 5.47 2 11C2 16.53 6.47 21 12 21C17.53 21 22 16.53 22 11C22 5.47 17.53 1 12 1ZM12 19C7.59 19 4 15.41 4 11C4 6.59 7.59 3 12 3C16.41 3 20 6.59 20 11C20 15.41 16.41 19 12 19ZM15.59 6L12 9.59L8.41 6L7 7.41L10.59 11L7 14.59L8.41 16L12 12.41L15.59 16L17 14.59L13.41 11L17 7.41L15.59 6Z" fill="currentColor"/>
  </svg>
);
IconCancelRound.displayName = 'IconCancelRound';

export const IconUserSingle = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconCalendarMonth = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
  ...
  >
    <path d="M20 2H19V0.5C19 0.223858 18.7761 0 18.5 0H17.5C17.2239 0 17 0.223858 17 0.5V2H7V0.5C7 0.223858 6.77614 0 6.5 0H5.5C5.22386 0 5 0.223858 5 0.5V2H4C2.9 2 2 2.9 2 4V20C2 21.1 2.9 22 4 22H20C21.1 22 22 21.1 22 20V4C22 2.9 21.1 2 20 2ZM20 19.5C20 19.7761 19.7761 20 19.5 20H4.5C4.22386 20 4 19.7761 4 19.5V9.5C4 9.22386 4.22386 9 4.5 9H19.5C19.7761 9 20 9.22386 20 9.5V19.5ZM20 6.5C20 6.77614 19.7761 7 19.5 7H4.5C4.22386 7 4 6.77614 4 6.5V4.5C4 4.22386 4.22386 4 4.5 4H19.5C19.7761 4 20 4.22386 20 4.5V6.5Z" fill="currentColor"/>
<path d="M15.5 16C15.5 15.7239 15.7239 15.5 16 15.5H17C17.2761 15.5 17.5 15.7239 17.5 16V17C17.5 17.2761 17.2761 17.5 17 17.5H16C15.7239 17.5 15.5 17.2761 15.5 17V16Z" fill="currentColor"/>
<path d="M11 16C11 15.7239 11.2239 15.5 11.5 15.5H12.5C12.7761 15.5 13 15.7239 13 16V17C13 17.2761 12.7761 17.5 12.5 17.5H11.5C11.2239 17.5 11 17.2761 11 17V16Z" fill="currentColor"/>
<path d="M6.5 16C6.5 15.7239 6.72386 15.5 7 15.5H8C8.27614 15.5 8.5 15.7239 8.5 16V17C8.5 17.2761 8.27614 17.5 8 17.5H7C6.72386 17.5 6.5 17.2761 6.5 17V16Z" fill="currentColor"/>
<path d="M15.5 11.5C15.5 11.2239 15.7239 11 16 11H17C17.2761 11 17.5 11.2239 17.5 11.5V12.5C17.5 12.7761 17.2761 13 17 13H16C15.7239 13 15.5 12.7761 15.5 12.5V11.5Z" fill="currentColor"/>
<path d="M6.5 11.5C6.5 11.2239 6.72386 11 7 11H8C8.27614 11 8.5 11.2239 8.5 11.5V12.5C8.5 12.7761 8.27614 13 8 13H7C6.72386 13 6.5 12.7761 6.5 12.5V11.5Z" fill="currentColor"/>
<path d="M11 11.5C11 11.2239 11.2239 11 11.5 11H12.5C12.7761 11 13 11.2239 13 11.5V12.5C13 12.7761 12.7761 13 12.5 13H11.5C11.2239 13 11 12.7761 11 12.5V11.5Z" fill="currentColor"/>
  </svg>
);
IconCalendarMonth.displayName = 'IconCalendarMonth';

export const IconAlarm = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconLoadingIcon = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconDragHandle = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M7 5C7 3.89543 7.89543 3 9 3C10.1046 3 11 3.89543 11 5C11 6.10457 10.1046 7 9 7C7.89543 7 7 6.10457 7 5Z" fill="currentColor"/>
...
<path d="M7 11C7 9.89543 7.89543 9 9 9C10.1046 9 11 9.89543 11 11C11 12.1046 10.1046 13 9 13C7.89543 13 7 12.1046 7 11Z" fill="currentColor"/>
<path d="M13 11C13 9.89543 13.8954 9 15 9C16.1046 9 17 9.89543 17 11C17 12.1046 16.1046 13 15 13C13.8954 13 13 12.1046 13 11Z" fill="currentColor"/>
<path d="M7 17C7 15.8954 7.89543 15 9 15C10.1046 15 11 15.8954 11 17C11 18.1046 10.1046 19 9 19C7.89543 19 7 18.1046 7 17Z" fill="currentColor"/>
<path d="M13 17C13 15.8954 13.8954 15 15 15C16.1046 15 17 15.8954 17 17C17 18.1046 16.1046 19 15 19C13.8954 19 13 18.1046 13 17Z" fill="currentColor"/>
  </svg>
);
IconDragHandle.displayName = 'IconDragHandle';

export const IconSortAscending = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M11.9951 5.49512L7.99512 9.48512H10.9951V16.4951H12.9951V9.48512H15.9951L11.9951 5.49512ZM11.9951 5.49512L7.99512 9.48512H10.9951V16.4951H12.9951V9.48512H15.9951L11.9951 5.49512Z" fill="currentColor"/>
  </svg>
);
IconSortAscending.displayName = 'IconSortAscending';

export const IconSortDescending = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
    {...props}
  >
    <path d="M11.9951 16.4951L15.9951 12.5051H12.9951L12.9951 5.49512H10.9951L10.9951 12.5051H7.99512L11.9951 16.4951ZM11.9951 16.4951L15.9951 12.5051H12.9951L12.9951 5.49512H10.9951L10.9951 12.5051H7.99512L11.9951 16.4951Z" fill="currentColor"/>
  </svg>
);
IconSortDescending.displayName = 'IconSortDescending';

export const IconEmptyFlag = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
...
export const IconFilledFlag = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M13.6608 2.30388C13.5673 1.83646 13.1569 1.5 12.6802 1.5H3.5V20.5H5.5V13.5H11.2802C11.7569 13.5 12.1673 13.8365 12.2608 14.3039L12.3392 14.6961C12.4327 15.1635 12.8431 15.5 13.3198 15.5H20.5V3.5H14.7198C14.2431 3.5 13.8327 3.16354 13.7392 2.69612L13.6608 2.30388Z" fill="currentColor"/>
  </svg>
);
IconFilledFlag.displayName = 'IconFilledFlag';

export const IconRefreshIcon = ({ size = 24, color, style, ...props }: IconProps) => (
  <svg
    width={size} height={size} viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg"
    style={{ color, ...style }}
